...
};const set=(root,key,val)=>{let[parent,child]=branch(root,hash(key));child.val=val;child.key=key;console.log(parent.keys);parent.keys.splice(parent.keys.indexOf(key),1,key);console.log(parent.keys);return parent;};
