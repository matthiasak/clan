...
};const set=(root,key,val)=>{let[parent,child]=branch(root,hash(key));child.val=val;child.key=key;console.log(parent.keys);parent.keys.push(key);console.log(parent.keys);return parent;};
