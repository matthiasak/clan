...
var rAF=exports.rAF=typeof document!=='undefined'&&(requestAnimationFrame||webkitRequestAnimationFrame||mozRequestAnimationFrame)||process&&process.nextTick||function(cb){return setTimeout(cb,16.6);};// composition
// c :: (T -> U) -> (U -> V) -> (T -> V)
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {'use strict';Object.defineProperty(exports,"__esModule",{value:true});var rAF=typeof document!=='undefined'&&(requestAnimationFrame||webkitRequestAnimationFrame||mozRequestAnimationFrame)||process&&process.nextTick||function(cb){return setTimeout(cb,16.6);};// observables
