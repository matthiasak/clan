...
};const set=(root,key,val)=>{let[parent,child]=branch(root,hash(key));child.val=val;child.key=key;console.log(1,parent.keys,key);const index=parent.keys.indexOf(key);parent.keys.splice(index===-1?0:index,index===-1?0:1,key);console.log(2,parent.keys,key);return parent;};
