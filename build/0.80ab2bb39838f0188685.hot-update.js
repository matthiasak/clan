...
};const set=(root,key,val)=>{let[parent,child]=branch(root,hash(key));child.val=val;child.key=key;const index=parent.keys.indexOf(key);parent.keys.splice(index===-1?0:index,1,key);return parent;};
