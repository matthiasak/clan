...
const unset=(root,key)=>{let h=hash(key),[parent,child]=branch(root,h,-1);delete child[frag(h,3)];console.log(parent.keys);parent.keys.splice(parent.keys.indexOf(key),1);console.log(parent.keys);return parent;};
